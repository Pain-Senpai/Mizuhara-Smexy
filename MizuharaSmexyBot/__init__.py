...
pgram = Client("mizuharapyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
mongo_client = MongoClient(MONGO_DB_URI)
db = mongo_client.MizuharaSmexyBot
...
from MizuharaSmexyBot.modules.helper_funcs.handlers import (CustomCommandHandler,
...
end_credits = """
INFO GATHERED!
Client: Mizuhara Pyro
Under Project Tsukiyomi 
Made With heart by Team Smexy
Copyright: (c) 2021 MizuharaSmexyBot
"""
print(end_credits)
